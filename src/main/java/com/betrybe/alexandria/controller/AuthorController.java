...
public class AuthorController {
  ...
  public AuthorDto getAuthorById(@PathVariable Long id) throws AuthorNotFoundException {
    //Transformo o Author encontrado em AuthorDto após encontrá-lo
  ...
  public List<AuthorDto> getAllAuthors() {
    ...
    //transformo a lista de autores em uma stream, e para cada author, transformo em um authorDto e faço uma lista
  ...
  public AuthorDto createAuthor(@RequestBody AuthorCreationDto authorCreationDto){
    return AuthorDto.fromEntity(authorService.createAuthor(authorCreationDto.toEntity()));
  }
  ...
  return AuthorDto.fromEntity(authorService.updateAuthor(id, authorCreationDto.toEntity()));
